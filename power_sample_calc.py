...
CITATIONS = {
    ...
    "normal_approx_prop": ("Penn State STAT 500: Probability Distributions and Sampling Distributions",
    ...
    "icc_info": ("Power and Sample Size Determination - Boston University School of Public Health",
